...
* List of articles on [Fairness, Accountability, and Transparency in Machine Learning](https://www.fatml.org/resources/relevant-scholarship)
...
* [The ethics of algorithms: Mapping the debate](http://journals.sagepub.com/doi/pdf/10.1177/2053951716679679), Brent Daniel Mittelstadt, Patrick Allo, Mariarosaria Taddeo, Sandra Wachter and Luciano Floridi, 2016 *(paper)*
* [ASILOMAR AI principles](https://futureoflife.org/ai-principles/?submitted=1#confirmation) *(article)*
* [The Ethics of Artificial Intelligence](https://intelligence.org/files/EthicsofAI.pdf), Nick Bostrom and Eliezer Yudkowsky, Machine Intelligence Research Institute *(paper)*
* [Toward an Ethics of Algorithms: Convening, Observation, Probability, and Timeliness](http://mike.ananny.org/papers/ananny_towardAnEthicsOfAlgorithms_2015.pdf), Mike Ananny, 2015 *(paper)*
##### Optional
* [EthicsNet](https://www.ethicsnet.com/), a dataset for machine ethics
* [Moral Machine by MIT](http://moralmachine.mit.edu/), a crowd-sourced picture of human opinion on how machines should make decisions when faced with moral dilemmas
* [Crowdsourcing Empathy](https://deepempathy.mit.edu/) by MIT, 2017
* [Ethically aligned design: A Vision for Prioritizing Human Wellbeing with Artificial Intelligence and Autonomous Systems](http://standards.ieee.org/develop/indconn/ec/ead_v1.pdf), IEEE, 2016 *(paper)*
* [Towards a machine ethics](https://pacita.strast.cz/files/prezentace/session_xvii_bendel.pdf), Prof. Dr. Oliver Bendel *(paper)*
* [Moral Decision Making Frameworks for Artificial Intelligence](https://users.cs.duke.edu/~conitzer/moralAAAI17.pdf), Vincent Conitzer, Walter Sinnott-Armstrong, Jana Schaich Borg, Yuan Deng, Max Kramer *(paper)*
* [Toward Ensuring Ethical Behavior from Autonomous Systems: A Case-Supported Principle-Based Paradigm](https://aaai.org/ocs/index.php/WS/AAAIW15/paper/view/9976/10125), Michael Anderson, Susan Leigh Anderson, 2015 *(paper)*
...
### Discrimination
* [Understanding Fair Labor Practices in a Networked Age](https://datasociety.net/pubs/fow/FairLabor.pdf) by Tamara Kneese, Alex Rosenblat, and Danah Boyd, 2014 *(paper)*
